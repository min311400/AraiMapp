             ...
             on(map,'load', function(){
              ...
              //--------------------- 7 -11  ---------------------------------- 
                ...
                var myPoint = {
                  ...
                  "infoTemplate":
                  {"title":"Condo",
                  "content":"${Name}  <img  src=${pic} style=${picStyle} > <br> คอนโดทำเลศักยภาพ ตั้งอยู่บนถนนพุทธบูชา เชื่อมต่อกับถนนสายหลักหลายเส้นทาง เช่น ประชาอุทิศ สุขสวัสดิ์ พระราม2 ใกล้ทางด่วนสุขสวัสดิ์ รองรับเส้นทางการคมนาคมในอนาคต (สถานีรถไฟฟ้าประชาอุทิศ รถไฟฟ้าสายสีม่วงเตาปูน-ราษฎร์บูรณะ) สะดวกต่อการเดินทาง ใกล้มหาวิทยาลัยเทคโนโลยีพระจอมเกล้าธนบุรี (บางมด) มีสิ่งอำนวยความสะดวกบริเวณใกล้เคียงมากมาย เช่น Lotus ประชาอุทิศ Max Value ตลาดทุ่งครุ สำนักงานเขตทุ่งครุ   <br> <a href=${scroll}> <h6 onClick=${onClick}>คลิกที่นี่เพื่อดูรายละเอียดห้อง</h6> </a>"}
                };
